      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>No need to worry just rent and ride.</p>
            <a href="#explore" class="btn">Check Bikes <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<!-- Resent Cat-->
<section class="section-padding gray-bg" id="explore">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Available Bikes for rent</a></li>
        </ul>
      </div>
